...
### Model
Let $z_{i} \in \left\{ 1, \dots, H \right\}$ be the cluster membership latent variable.

$$\begin{align*}
  y_{i} | (\mathbf{z}_{i}, \mu_{1},\dots,\mu_{H}, \sigma^{2}_{1},\dots,\sigma^{2}_{H}) &\sim N(\mu_{z_{i}}, \sigma^{2}_{z_{i}})
  \end{align*}
$$

...
pairs(normal_fixed_mixture_stan_fit6, pars = "mu")
pairs(normal_fixed_mixture_stan_fit6, pars = "sigma_squared")
pairs(normal_fixed_mixture_stan_fit6, pars = "Pi")
```

This model broke down badly.

#### 6 latent cluster model with unordered mu
```{r}
...
```
```{r, cache = TRUE, results = 'hide'}
normal_fixed_mixture_stan_fit6_unordered <-
...
```{r}
normal_fixed_mixture_stan_fit6_unordered
traceplot_all(normal_fixed_mixture_stan_fit6_unordered)
plot_draws(normal_fixed_mixture_stan_fit6_unordered)
pairs(normal_fixed_mixture_stan_fit6_unordered, pars = "mu")
pairs(normal_fixed_mixture_stan_fit6_unordered, pars = "sigma_squared")
pairs(normal_fixed_mixture_stan_fit6_unordered, pars = "Pi")
```
...
pairs(normal_fixed_mixture_stan_fit1)
```
...
pairs(normal_fixed_mixture_stan_fit2, pars = "mu")
pairs(normal_fixed_mixture_stan_fit2, pars = "sigma_squared")
pairs(normal_fixed_mixture_stan_fit2, pars = "Pi")
```
...
```{r}
normal_fixed_mixture_stan_fit2a
traceplot_all(normal_fixed_mixture_stan_fit2a)
plot_draws(normal_fixed_mixture_stan_fit2a)
```
...
```{r}
normal_fixed_mixture_stan_fit2b
traceplot_all(normal_fixed_mixture_stan_fit2b)
plot_draws(normal_fixed_mixture_stan_fit2b)
```
...
```{r}
normal_fixed_mixture_stan_fit2c
traceplot_all(normal_fixed_mixture_stan_fit2c)
plot_draws(normal_fixed_mixture_stan_fit2c)
```
...
```{r}
normal_fixed_mixture_stan_fit2d
traceplot_all(normal_fixed_mixture_stan_fit2d)
plot_draws(normal_fixed_mixture_stan_fit2d)
```
...
```{r}
normal_fixed_mixture_stan_fit2e
traceplot_all(normal_fixed_mixture_stan_fit2e)
plot_draws(normal_fixed_mixture_stan_fit2e)
```
...
```{r}
normal_fixed_mixture_stan_fit2f
traceplot_all(normal_fixed_mixture_stan_fit2f)
plot_draws(normal_fixed_mixture_stan_fit2f)
```
...
```{r}
normal_fixed_mixture_stan_fit2g
traceplot_all(normal_fixed_mixture_stan_fit2g)
plot_draws(normal_fixed_mixture_stan_fit2g)
```
...
```{r}
normal_fixed_mixture_stan_fit2h
traceplot_all(normal_fixed_mixture_stan_fit2h)
plot_draws(normal_fixed_mixture_stan_fit2h)
```
...
```{r}
normal_fixed_mixture_stan_fit2i
traceplot_all(normal_fixed_mixture_stan_fit2i)
plot_draws(normal_fixed_mixture_stan_fit2i)
```
...
```{r}
normal_fixed_mixture_stan_fit2j
traceplot_all(normal_fixed_mixture_stan_fit2j)
plot_draws(normal_fixed_mixture_stan_fit2j)
```

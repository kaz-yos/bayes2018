...
```{r}
normal_fixed_mixture_stan_fit
traceplot(normal_fixed_mixture_stan_fit, pars = sprintf("mu[%s]", 1:6))
traceplot(normal_fixed_mixture_stan_fit, pars = sprintf("sigma[%s]", 1:6))
traceplot(normal_fixed_mixture_stan_fit, pars = sprintf("Pi[%s]", 1:6))
```

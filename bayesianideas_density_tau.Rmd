...
## For vague prior fit
bad_chains <- c(17L, 3L, 9L, 22L, 5L, 32L, 2L, 23L,
                36L, 15L, 26L, 14L, 34L, 30L, 31L, 28L, 20L, 1L, 8L, 19L, 35L,
                13L, 16L, 18L, 7L)
...
## For vague prior fit
bad_chains <- c(3L, 26L, 6L, 19L, 7L, 9L, 35L, 1L,
                12L, 20L, 14L, 23L, 5L, 10L, 27L, 36L, 22L, 21L, 29L, 13L, 31L,
                33L, 11L)

...
```
```{r}
traceplot(piecewise_ph_model, inc_warmup = TRUE, pars = c("lambda","beta","lp__"))
traceplot(piecewise_ph_model, inc_warmup = FALSE, pars = c("lambda","beta","lp__"))
```
...
```
```{r}
traceplot(piecewise_ph_model2, inc_warmup = TRUE, pars = c("lambda","beta","lp__"))
traceplot(piecewise_ph_model2, inc_warmup = FALSE, pars = c("lambda","beta","lp__"))
```
--------------------

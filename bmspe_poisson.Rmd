...
draw_data <- extract_post_pred(stan_model_poisson)
sample_indices <- sample(seq_len(max(draw_data$.iteration)), size = 20)
...
draw_data <- extract_post_pred(stan_model_poisson_covs)
sample_indices <- sample(seq_len(max(draw_data$.iteration)), size = 20)

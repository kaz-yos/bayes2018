...
bind_rows(
  rel_dbinom(X = 5, theta0 = 0.6, theta1 = 0.5),
  rel_dbinom(X = 9, theta0 = 0.6, theta1 = 0.5),
  rel_dbinom(X = 8, theta0 = 0.6, theta1 = 0.5),
  rel_dbinom(X = 4, theta0 = 0.6, theta1 = 0.5),
  rel_dbinom(X = 7, theta0 = 0.6, theta1 = 0.5)
)
#+END_SRC
\normalsize

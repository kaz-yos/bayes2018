...
persp(x = grid, y = grid, z = mat_lik,
      xlim = c(0,1), ylim = c(0,1),
      main = "Incomplete-Data Likelihood",
      xlab = "theta0", ylab = "theta1", zlab = "Likelihood")

persp(x = grid, y = grid, z = mat_exp_g1,
      xlim = c(0,1), ylim = c(0,1),
      main = "exp(g1(theta))",
      xlab = "theta0", ylab = "theta1", zlab = "exp(g1(theta))")

persp(x = grid, y = grid, z = mat_exp_g2,
      xlim = c(0,1), ylim = c(0,1),
      main = "exp(g2(theta))",
      xlab = "theta0", ylab = "theta1", zlab = "exp(g2(theta))")

persp(x = grid, y = grid, z = mat_exp_g3,
      xlim = c(0,1), ylim = c(0,1),
      main = "exp(g3(theta))",
      xlab = "theta0", ylab = "theta1", zlab = "exp(g3(theta))")
#+END_SRC
\normalsize

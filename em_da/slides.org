...
points3d(x = thetahat0[1], y = thetahat0[2], z = exp(llik_incompl(thetahat0[1], thetahat0[2])))
...
points3d(x = thetahat1[1], y = thetahat1[2], z = exp(llik_incompl(thetahat1[1], thetahat1[2])))
...
points3d(x = thetahat2[1], y = thetahat2[2], z = exp(llik_incompl(thetahat2[1], thetahat2[2])))
...
points3d(x = thetahat4[1], y = thetahat4[2], z = exp(llik_incompl(thetahat4[1], thetahat4[2])))
...
points3d(x = thetahat5[1], y = thetahat5[2], z = exp(llik_incompl(thetahat5[1], thetahat5[2])))

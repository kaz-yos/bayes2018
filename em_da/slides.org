...
lines(with(lik_data_gt, trans3d(theta0, theta1, exp_g1, pmat = pmat_lik)), col = "blue", alpha = 0.1)
lines(with(lik_data_gt, trans3d(theta0, theta1, exp_g2, pmat = pmat_lik)), col = "red")
lines(with(lik_data_gt, trans3d(theta0, theta1, exp_g3, pmat = pmat_lik)), col = "green")
lines(with(lik_data_gt, trans3d(theta0, theta1, exp_g4, pmat = pmat_lik)), col = "yellow")
lines(with(lik_data_gt, trans3d(theta0, theta1, lik, pmat = pmat_lik)), col = "black")

...
* DA Method
** From EM to DA
- A related Bayesian computation method is the /Data Augmentation/ method. cite:schaferAnalysisIncompleteMultivariate1999
- We will examine its similarities to and differences from the EM algorithm.
...
- Posterior
\begin{align*}
  p(\btheta | \bX) &= \sum_{\bz} p(\btheta, \bz | \bX)\\

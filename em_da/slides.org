...
\begin{align*}
  ...
  &~~~~~~~~~ \left.
    ...
    \right\}
\end{align*}
- We can take partial derivatives with respect to $\theta_{0}$ and $\theta_{1}$ and set them to zero to solve for MLE.
...
*** @@latex:@@                                                        :BMCOL:
    ...
    :BEAMER_col: 0.50
    :END:
- A likelihood function is convex.
- There is a unique maximum with an analytical solution.
...
*** @@latex:@@                                                        :BMCOL:
    ...
    :BEAMER_col: 0.50
    :END:
- Multiple initial starting parameters is often helpful.
...
** Title Stan
   ...
   :END:
#+BEGIN_CENTER
\resizebox{\linewidth}{!}{Stan}
#+END_CENTER
** Stan: Hamiltonian Monte Carlo
- Stan is a modern Bayesian MCMC sampler.
...
\scriptsize
#+HEADER: :width 5 :height 5
#+BEGIN_SRC R :session *R-org* :results output graphics :file ./source/figure_stan.pdf :exports both

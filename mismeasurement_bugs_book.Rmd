...
- Gustafson. Measurement Error and Misclassification. Chapter 4.
...
Since the missing process is ignorable, we can work on the other parts only. We partition the true exposure $X_{true}$ into the complete part and

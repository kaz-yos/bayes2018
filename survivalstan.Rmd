...
-
- R packages
  - [bayesSurv](https://cran.r-project.org/web/packages/bayesSurv/index.html)
- SurvivalStan (Python)
...
## Background
Survival analysis is at the core of epidemiological data analysis. There are multiple well-known Bayesian data analysis textbooks, but they typically do not cover survival analysis. Here I will show case some R examples of Bayesian survival analysis.

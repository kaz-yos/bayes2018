...
Stan parameterizes this probability density function as follows.

$$f(x|\alpha,\sigma) =
\frac{\alpha}{\sigma}\left(\frac{x}{\sigma}\right)^{\alpha-1}e^{-(x/\sigma)^{\alpha}}$$

where $\alpha$ is the shape parameter and $\sigma$ is the scale parameter. To incorporate covariates, the scale parameter is defined as follows

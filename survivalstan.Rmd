...
Now we can plot the posterior predictive distributions of survival times for each group. This plot is comparing two conditional density functions $f_{T|X}(t|1)$ and $f_{T|X}(t|0)$.
